      ...
      html: `
         <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
           <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
             ...
             <h2 style="color: #ffcf0b; text-align: center;">Application Received</h2>
  ...
  try {
    const info = await mailer.sendMail({
      ...
      html: `
         <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
           <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
             <h2 style="color: #ffcf0b; text-align: center;">New Application Received</h2>
             <p>Dear Admin,</p>
  ...
  try {
    const info = await mailer.sendMail({
      ...
      html: `
         <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
           <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
             <h2 style="color: #ffcf0b; text-align: center;">Congratulations!</h2>
             <p>Dear ${applicantName},</p>
             ...
             <p>You can now officially represent our organization. To learn more about your role, visit the <a href="${countryRepPage}" style="color: #ffcf0b;">Country Representative Page</a>.</p>
      ...
      html: `
         <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
           <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
             ...
             <h2 style="color: #ffcf0b; text-align: center;">Country Representative Payment Request</h2>
             <p>Dear Applicant,</p>
             ...
             <h3 style="color: #ffcf0b;">Payment Links:</h3>
             <p>You can securely complete your payment using one of the following options:</p>
             <ul>
               <li><strong>PayPal:</strong> <a href="${paypal_link}" style="color: #ffcf0b;">Click here to pay via PayPal</a></li>
               <li><strong>Stripe:</strong> <a href="${stripe_link}" style="color: #ffcf0b;">Click here to pay via Stripe</a></li>
             </ul>
  ...
  try {
    const info = await mailer.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
          <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            <h2 style="color: #ffcf0b; text-align: center;">Payment Confirmed</h2>
            <p>Dear ${applicantName},</p>
