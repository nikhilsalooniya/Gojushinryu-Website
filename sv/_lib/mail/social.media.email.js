...
async function sendImageUploadReport(postTitle = '', status) {
  try {
    ...
    const emailHtml = `
     <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
       <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
         <h2 style="color: #ffcf0b; text-align: center;">📢 Image Upload Report</h2>
         <p>Dear Admin,</p>
         ...
         <p>Please check your <a href="${BASE_URL}/control-panal" style="color: #ffcf0b;">Control Panel</a> to retry failed uploads.</p>
         <p>Best regards,<br><strong>${ORGANIZATION_NAME} Team</strong></p>
       </div>
     </div>`;
...
async function sendVideoUploadReport(postTitle, status) {
  try {
    ...
    const emailHtml = `
     <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
       <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
         <h2 style="color: #ffcf0b; text-align: center;">🎥 Video Upload Report</h2>
         <p>Dear Admin,</p>
...
async function sendTextPostUploadReport(postTitle, status) {
  try {
    ...
    const emailHtml = `
     <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
       <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
         <h2 style="color: #ffcf0b; text-align: center;">📝 Text Post Upload Report</h2>
         <p>Dear Admin,</p>
