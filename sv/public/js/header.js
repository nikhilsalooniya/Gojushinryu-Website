...
function loadH3(params) { 
      ...
      h3.innerHTML = `
        <div style="display: flex; align-items: center; justify-content: center;gap: 10px;">
              ...
              <a href="/courses" > Book Your First Class Free</a> / School of  Traditional Martial Arts
        </div>
        `;
      topBar.appendChild(h3);
      h3.querySelector('a').style.textDecoration='underline';
      h3.querySelector('a').style.textDecorationLine='underline';
      h3.querySelector('a').style['-webkit-text-decorations-in-effect'] = 'underline';
      h3.style.right='-80vw';
      setTimeout(e=> {
      ...
      setTimeout(e=> h3.remove(),15000);
      setTimeout(loadH3, 15000);
}
